...
Title.TextSize = 18
Title.Text = "Breaking Yield FE v"..ver
...
CMDs[#CMDs + 1] = {NAME = 'BreakIn', DESC = 'Loads ! AABBCCDD Break In Gui'}
...
addcmd('breakloops',{'break'},function(args, speaker)
	notify("Command", "The Owner Broke This Command Somehow")
end)


addcmd('breakin',{},function(args, speaker)
	loadstring(game:HttpGet('https://raw.githubusercontent.com/Kitty-Admin/Break-In-Gui/main/README.md'))()
end)
